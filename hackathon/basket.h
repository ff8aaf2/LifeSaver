...
@property (strong, nonatomic) IBOutlet UITextField *myday;
@property (strong, nonatomic) IBOutlet UITextField *myhours;
@property (strong, nonatomic) IBOutlet UITextField *mytime;
@property (strong, nonatomic) IBOutlet UIView *myview;
- (IBAction)btn_contanue:(id)sender;
@property (strong, nonatomic) IBOutlet UIButton *btn_moafeg;
- (IBAction)btn_moafeg:(id)sender;



@property (strong, nonatomic) IBOutlet UILabel *mytwseel_time;

@property (strong, nonatomic) IBOutlet UIButton *btn_total;
